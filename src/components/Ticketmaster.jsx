...
export function AccordionList() {
  ...
  return (
    <nav aria-label="Cuenta" className="sc-3aee2bbf-0 eKzqlE snipcss-RbyUz">
      {user && (
        <div className="sc-2eac59d2-0 hnrVgv sc-3aee2bbf-8 hyfQnY">
          <p className="sc-2eac59d2-1 dcACgO">
            <span className="sc-2eac59d2-2 hkuUpY">¡Bienvenido de vuelta!</span>{" "}
            <span data-cs-mask="true" className="sc-2eac59d2-3 hCxDWU">
              {user.name || "Usuario"}{" "}
            </span>
          </p>
        </div>
        ...
        <div className="sc-75d02ffe-3 jnzhWU">
          <div className="sc-75d02ffe-4 dMaXer">
            ...
            <div className="sc-6eb17e37-0 bGosfa">
              ...
              >
                <li role="listitem" className="sc-6eb17e37-3 ebMhgC">
                  <a
                    href="https://www.facebook.com/TicketmasterMexico/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="Link__StyledLink-sc-pudy0l-0 coVzbU sc-6eb17e37-4 hSTWqW"
                  >
                    <img
                      alt="Facebook"
                      title="Facebook"
                      src="https://uk.tmconst.com/rc-e1d4d70b/images/logo/facebook.svg"
                      className="sc-6eb17e37-5 iJVoWV"
                    />
                    <span className="VisuallyHidden-sc-8buqks-0 lmhoCy">
                ...
                <li role="listitem" className="sc-6eb17e37-3 ebMhgC">
                  ...
                  >
                    <img
                      alt="Youtube"
                      title="Youtube"
                      src="https://uk.tmconst.com/rc-e1d4d70b/images/logo/youtube.svg"
                      className="sc-6eb17e37-5 iJVoWV"
                    />
                    <span className="VisuallyHidden-sc-8buqks-0 lmhoCy">
                      (Abre una nueva pestaña)
                ...
                <li role="listitem" className="sc-6eb17e37-3 ebMhgC">
                  ...
                  >
                    <img
                      alt="TikTok"
                      title="TikTok"
                      src="https://uk.tmconst.com/rc-e1d4d70b/images/logo/tiktok.svg"
                      className="sc-6eb17e37-5 iJVoWV"
                    />
                    <span className="VisuallyHidden-sc-8buqks-0 lmhoCy">
                      (Abre una nueva pestaña)
                ...
                <li role="listitem" className="sc-6eb17e37-3 ebMhgC">
                  ...
                  >
                    <img
                      alt="Blog"
                      title="Blog"
                      src="https://uk.tmconst.com/rc-e1d4d70b/images/logo/blog.svg"
                      className="sc-6eb17e37-5 iJVoWV"
                    />
                    <span className="VisuallyHidden-sc-8buqks-0 lmhoCy">
                      (Abre una nueva pestaña)
                ...
                <li role="listitem" className="sc-6eb17e37-3 ebMhgC">
                  ...
                  >
                    <img
                      alt="Spotify"
                      title="Spotify"
                      src="https://uk.tmconst.com/rc-e1d4d70b/images/logo/spotify.svg"
                      className="sc-6eb17e37-5 iJVoWV"
                    />
                    <span className="VisuallyHidden-sc-8buqks-0 lmhoCy">
                      (Abre una nueva pestaña)
                ...
                <li role="listitem" className="sc-6eb17e37-3 ebMhgC">
                  ...
                  >
                    <img
                      alt="LinkedIn"
                      title="LinkedIn"
                      src="https://uk.tmconst.com/rc-e1d4d70b/images/logo/linkedin.svg"
                      className="sc-6eb17e37-5 iJVoWV"
                    />
                    <span className="VisuallyHidden-sc-8buqks-0 lmhoCy">
                      (Abre una nueva pestaña)
            ...
            <div className="sc-6eb17e37-0 bGosfa">
              <h2 className="sc-6eb17e37-1 cOwoaK">
              </h2>
              <ul
                role="list"
                className="UnstyledList-sc-ix96mm-0 sc-6eb17e37-2 ekOJfs iUpJNd"
