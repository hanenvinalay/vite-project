    ...
    <div className='sc-6680851a-2 bbgxWO snipcss0-1-1-148 snipcss0-0-0-1'>
      ...
      >
        <div
          ...
          tabIndex={-1}
          aria-modal='true'
          className='SidePanel__StyledSidePanel-sc-1vmo9z7-0 hxCvoI snipcss-Y83tB style-ATwzX'
          aria-label='Mi Cuenta'
          data-enter='true'
        >
          <div className='SidePanel__StyledHeader-sc-1vmo9z7-1 cvVDZQ'>
            <div className='SidePanel__StyledTitleContainer-sc-1vmo9z7-3 cpewAG'>
              <h1
                id=':r3:'
                className='SidePanel__StyledTitle-sc-1vmo9z7-4 dbtRDX'
              >
                Mi Cuenta
              </h1>
            </div>
            <button
              id='AcountPanel'
              onClick={onClose}
              className='SquareButton__StyledSquareButton-sc-1njhw9f-0 ydDMU SidePanel__StyledIconButton-sc-1vmo9z7-2 jdjnGW'
              type='button'
            >
              ...
              <span className='VisuallyHidden-sc-8buqks-0 lmhoCy'>Cerrar</span>
            </button>
          </div>
          <div
            tabIndex={-1}
            className='SidePanel__StyledContent-sc-1vmo9z7-7 jgPXDl'
          >
